...
const MindsRestaurants = () => {
    ...
    const loadRestaurants = async () => {
      ...
      try {
        ...
        if (restaurantData && restaurantData.statusCode === 0) {
          const fetchedRestaurants = restaurantData.data.cards
            .slice(2)
            .map((card) => {
  ...
  // console.log(restaurantData.data.cards[0].card.card.title);
  

  return (
    <div>
    {/* <div className="pl-32 mt-6 mb-4">
        <h2 className="text-2xl font-bold text-gray-800 mb-1 truncate">Restaurants Title</h2>
      </div> */}
