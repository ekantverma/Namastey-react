            ...
            <div className="w-6/12 m-auto">
                {cartItems.length === 0 ? (
                    <div className="text-center">
                        ...
                        <p className="text-gray-600 mb-4">You can go to the home page to view more restaurants</p>
                        <Link to="/">
                        <button
                            className="bg-orange-600 text-white p-2 rounded-lg hover:bg-orange-500 transition duration-300" 
                        >
                    ...
                    <div>
                                ...
                                >
                                    ...
                                    <div className="w-9/12 flex flex-col justify-between">
                                        <div>
                                            ...
                                            <div className="text-green-700 text-xl">₹ {price.toFixed(2)}</div>
                                            <div className="text-gray-500 text-sm mb-4">
                                                Quantity: {quantity} x ₹ {price.toFixed(2)} = ₹ {totalPrice.toFixed(2)}
                                            </div>
                                        </div>
                                        <button
                        ...
                        <div className="bg-gray-100 p-4 rounded-lg shadow-md mt-4">
                            ...
                            <div className="flex justify-between font-bold mt-4">
                                ...
                                <span>₹ {parseFloat(getTotalPrice()) + 47 - 25 + 7.01 + 49.03}</span>
                            </div>
                        </div>
                    </div>
                )}
